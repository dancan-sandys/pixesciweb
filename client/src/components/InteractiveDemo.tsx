...
const scenarios: DemoScenario[] = [
  {
    ...
    command: "Show me every assay where cytokine response correlated with reagent lot, instrument, or analyst",
    steps: [
      "Querying LIMS for reagent lot usage patterns...",
      "Cross-referencing ELN experiment records...", 
      "Analyzing plate reader data correlations...",
      "Checking QMS analyst qualification records...",
    ],
    result: "Found: 14 experiments using lot B17, 12 passed, 2 flagged OOS on same plate reader by same analyst",
    tools: ["LIMS", "ELN", "Plate Reader", "QMS"],
  },
  {
    id: "compliance",
    icon: Microscope,
    title: "Compliance Workflow",
    command: "When plate reader analysis finishes, update LIMS with results, create ELN entry, and trigger QMS deviation workflow if OOS",
    steps: [
      "Plate reader analysis completion detected...",
      "Updating LIMS with assay results...",
      "Creating ELN experiment entry with data links...",
      "Checking acceptance criteria and triggering QMS workflow...",
    ],
    result: "Workflow complete: LIMS updated, ELN entry created, OOS deviation automatically logged in QMS",
    tools: ["Plate Reader", "LIMS", "ELN", "QMS"],
  },
  {
    id: "data-integrity",
    icon: Dna,
    title: "Data Integrity Check",
    command: "Check if all samples from batch B24 have complete documentation across LIMS, ELN, and CDS",
    steps: [
      "Querying LIMS for batch B24 sample records...",
      "Cross-referencing ELN experiment documentation...",
      "Checking CDS instrument data completeness...",
      "Generating data integrity report...",
    ],
    result: "Integrity check complete: 47/48 samples fully documented, 1 sample missing CDS calibration record",
    tools: ["LIMS", "ELN", "CDS"],
  },
  {
    id: "cloning",
    ...
    <section className="py-16 bg-background border-t border-border/50" data-testid="section-demo">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto">
            ...
            {selectedScenario && (
              ...
              >
                <Card className="overflow-hidden">
                  ...
                  <div className="p-6 font-mono text-sm h-[480px] overflow-y-auto">
          ...
          {!selectedScenario && (
            <div className="h-[533px] flex flex-col items-center justify-center border-2 border-dashed border-border/50 rounded-lg">
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
