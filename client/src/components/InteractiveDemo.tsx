...
const scenarios: DemoScenario[] = [
  ...
  },
  {
    ...
    command: "When FlowJo analysis completes, generate Prism figures, run QSAR prediction, update ELN, and prepare FDA submission package",
    steps: [
      "FlowJo analysis completion detected...",
      "Generating figures in GraphPad Prism...",
      "Running QSAR prediction models...",
      "Updating ELN with results and figures...",
    ],
    result: "Workflow complete: Figures generated, QSAR predictions updated, ELN entry linked, FDA package drafted",
    tools: ["FlowJo", "Prism", "QSAR", "ELN"],
  },
  {
    id: "genomics",
    icon: Dna,
